...
<script type="text/javascript">
	...
	$(function(){
		...
		$('.topmenu li').click(function(){
			...
			console.info(id);
			$("#menu").attr("src","${pageContext.request.contextPath }/web/loginAction/menu?id="+id);
		});
	})
</script>
</head>
	...
	<div class="easyui-layout" fit="true" >
		<div data-options="region:'north'"
			...
			<ul class="topmenu">
				...
				<li><a href="${pageContext.request.contextPath}/web/loginAction/logout" class="c5"> <img
		...
		<div data-options="region:'west',split:false" style="width:200px; border-right:3px solid #bbb;">
			<iframe id="menu" width="100%" height="99%" frameborder="0" src="${pageContext.request.contextPath }/web/loginAction/menu"></iframe> 
		</div>
		<div id="mainpanelcontainer" data-options="region:'center'">
			 <iframe id="main" name="mainFrame" width="100%" height="99%" frameborder="0" src="${pageContext.request.contextPath }/web/loginAction/home"></iframe> 
		</div>
	</div>
