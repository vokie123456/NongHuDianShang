...
<script type="text/javascript">
	...
	function checkPhone() {
		...
		// 3.打开连接
		xhr.open("GET",
				"${pageContext.request.contextPath}/userController/checkPhone?time="
						+ new Date().getTime() + "&phonenumber=" + phone, true);
		// 4.发送
		xhr.send(null);
	}
	function checkCode() {
		...
		// 3.打开连接
		xhr.open("GET",
				"${pageContext.request.contextPath}/userController/checkCode?time="
						+ new Date().getTime() + "&checkcode=" + checkcode,
				true);
		// 4.发送
		xhr.send(null);
	}
	function checkEmail() {
		...
		// 3.打开连接
		xhr.open("GET",
				"${pageContext.request.contextPath}/userController/checkEmail?time="
...
<body>
					...
					<form id="registerForm"
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="password" id="password"
										placeholder="8位以上密码！" name="password" class="text"
										maxlength="18" /> <span></span></td>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>确认密码:</th>
									<td><input id="repassword" type="password"
										placeholder="再次输入密码！" name="repassword" class="text"
										maxlength="18" /></td>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>E-mail:</th>
									<td><input type="text" id="email" name="email"
										placeholder="您的邮箱！" onblur="checkEmail()"
										onmouseout="checkEmail()" class="text" maxlength="30" /> <span
										id="span2"></span></td>
								</tr>
								<tr>
									<th>手机号码:</th>
									<td><input type="text" id="phone" placeholder="11位手机号码！"
										name="phonenumber" onmouseout="checkPhone()" maxlength="11"
										onblur="checkPhone()" class="text" /> <span id="span4"></span>
									</td>
								</tr>
								...
								<tr>
									...
									<td><span class="fieldSet"> <input type="text"
											id="checkcode" name="checkcode" onblur="checkCode()"
											onmouseout="checkCode()" class="text captcha" maxlength="5" /><img
						...
						<div class="login">
							...
							<dl>
								...
								<dd>
									立即登录即可体验在线购物！ <a
										href="${ pageContext.request.contextPath }/loginController/login">立即登录</a>
								</dd>
							</dl>
						</div>
					</form>
	...
	<div id="_my97DP"
		...
		<iframe style="width: 190px; height: 191px;"
			src="${ pageContext.request.contextPath }/loginController/regist"
