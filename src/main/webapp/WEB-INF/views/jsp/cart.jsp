	...
	<div class="span5">
		<div class="logo">
			<a href="http://localhost:8080/mango/">
				<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/logo.gif" alt="农户电商"/>
			</a>
		</div>
	</div>
	<div class="span9">
<div class="headerAd">
	...
	<%@ include file="menu.jsp" %>
		...
		<c:when test="${session.cart.cartItems.size()}!= 0">
		<div class="span24">
				...
				<table>
					...
					<tr>
						...
						<tr>
							...
							<td>
								<a href="${ pageContext.request.contextPath }/cart_removeCart.action?pid=${cartItem.product.pid}" class="delete">删除</a>
							</td>
						</tr>
						</c:forEach>
					</tbody>
