			...
			<div class="info">
				<dl>
					...
					<dl>
						<dt>促销:</dt>
						<dd>
								<a target="_blank" title="限时抢购 (2017-08-30 ~ 2017-09-30)">限时抢购</a>
						</dd>
					</dl>
					<dl>
						<dt>    </dt>
